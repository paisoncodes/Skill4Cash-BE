# Generated by Django 3.2.9 on 2022-10-04 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=225), blank=True, default=list, null=True, size=None)),
                ('gallery', django.contrib.postgres.fields.ArrayField(base_field=models.URLField(), blank=True, default=list, null=True, size=None)),
                ('card_front', models.URLField(blank=True, default=str, null=True)),
                ('card_back', models.URLField(blank=True, default=str, null=True)),
                ('pob', models.URLField(blank=True, default=str, null=True, verbose_name='Proof of Business')),
